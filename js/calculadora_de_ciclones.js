// TROQUEI O NOME DAS SEGUINTES UNIDADES
// D_particula -> d_particula
// D_particula_unit -> d_particula_unit
//
//
//
...
function tem_o_ciclone() {
    // Input do usuário
    let D_ciclone = converter_diametro(document.getElementById("D_ciclone").value, document.getElementById("D_ciclone_unit").value);
...
function nao_tem_o_ciclone() {
    ...
    let u = converter_velocidade(document.getElementById("velocidade").value, document.getElementById("velocidade_unit").value);
    let rho_fluido = converter_rho(document.getElementById("rho_fluido").value, document.getElementById("rho_fluido_unit").value);
    let rho_particula = converter_rho(document.getElementById("rho_particula").value, document.getElementById("rho_particula_unit").value);
    let viscosidade = converter_viscosidade();
    let dp = analise_granulometrica()[0];
...
function inserirLinhaTabela() {
    var table = document.getElementById("dp_perc");
...
function RemoverLinhaTabela() {
    ...
    if (numOfRows > 2) {
        ...
        alert("A tabela deve conter pelo menos um diâmetro de partícula!");
    }
